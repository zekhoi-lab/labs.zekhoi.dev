...
export const metadata: Metadata = {
  title: 'UUID Generator | v4, v5, v6, v7 Online Tool',
  description: 'Generate cryptographically strong UUIDs (v4, v5, v6, v7) instantly in your browser. Features name-based v5 UUIDs with custom namespaces, a recent history, and one-click copying. No ads.',
